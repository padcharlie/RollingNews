...
<Carousel className="mt-3">
    <Carousel.Item>
        <img src={process.env.PUBLIC_URL + "/images/covid1.png"} alt="Quédese en casa. Rolling news le da las noticias" className="img-fluid" />
    </Carousel.Item>
    <Carousel.Item>
        <img src={process.env.PUBLIC_URL + "/images/covid2.png"} alt="Lávese las manos con frecuencia y use barbijo. Rolling news le da las noticias" className="img-fluid" />
    </Carousel.Item><Carousel.Item>
        <img src={process.env.PUBLIC_URL + "/images/covid3.png"} alt="Mantenga la distancia social. Rolling news le da las noticias" className="img-fluid" />
    </Carousel.Item>
</Carousel>
</Container>
